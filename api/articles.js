  ...
  try {
    ...
    if (req.method === 'POST') {
      ...
      const { data, error } = await supabase.from('articles').insert({
        ...
        cover_image: b.cover_image, author: b.author || 'MohaanWeb', published: b.published || false,
        tags: b.tags || [], meta_title: b.meta_title, meta_description: b.meta_description,
      }).select().single();
      if (error) throw error;
